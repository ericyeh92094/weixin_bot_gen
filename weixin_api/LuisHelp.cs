...
namespace weixin_bot
{
    ...
    public class LuisHelp
    {
        ...
        public async Task<string> GetTunling123(string query, string mainTitle, string mainMsg, string fromUser, string toUser)
        {
            String APIKEY = "8b4fe884f37946e2b1981c2ea2dc7c66";
            string result = null;
            try
            {
                //注册码自己到网上注册去
